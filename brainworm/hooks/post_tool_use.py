...
if __name__ == "__main__":
    HookFramework("post_tool_use", enable_analytics=True).with_custom_logic(post_tool_use_logic).with_extractor(post_tool_use_analytics_extractor).with_success_handler(post_tool_use_success_message).execute()