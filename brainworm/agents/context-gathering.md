...
### CRITICAL: Determine Your Project Structure First
...
- **Service Boundaries**: Understand what belongs to this service vs others
- **Cross-Service Dependencies**: Document how services interact
- **Service-Specific CLAUDE.md**: Read the service's local CLAUDE.md first
- **Root Context**: Also read project root CLAUDE.md for overall architecture
