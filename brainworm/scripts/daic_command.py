...
app = typer.Typer(
    name="daic",
    help="DAIC Mode Control - Switch between discussion and implementation modes",
...
def show_status_info(project_root: Path) -> None:
...
@app.command(name="discussion", help="Switch to discussion mode")
def discussion() -> None:
...
@app.command(name="implementation", help="Switch to implementation mode")
...
@app.command(name="status", help="Show current DAIC mode status")
def status() -> None:
    """Show current DAIC mode status"""
    project_root = find_project_root()
    show_status_info(project_root)


@app.command(name="toggle", help="Toggle between discussion and implementation modes")
def toggle() -> None:
    ...
    set_daic_mode(project_root, new_mode, "manual_toggle")
